...
{{/*
  Define the name of the sql PVC
*/}}
{{- define "sql.pvcName" -}}
{{ printf "%s-%s" (include "sql.fullname" .) "pvc" | trunc 63 | trimSuffix "-"  }}
{{- end -}}

{{/*
  Define the name of the sql secret
*/}}
{{- define "sql.secretName" -}}
{{ printf "%s-%s" (include "sql.fullname" .) "secret" | trunc 63 | trimSuffix "-"  }}
{{- end -}}
