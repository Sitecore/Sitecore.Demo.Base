...
Common labels
*/}}
{{- define "indexworker.labels" -}}
helm.sh/chart: {{ include "indexworker.chart" . }}
{{ include "indexworker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "indexworker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "indexworker.name" . }}
...
*/}}
{{- define "indexworker.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "indexworker.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
