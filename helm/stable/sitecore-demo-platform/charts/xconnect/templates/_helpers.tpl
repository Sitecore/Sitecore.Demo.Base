...
Common labels
*/}}
{{- define "xconnect.labels" -}}
helm.sh/chart: {{ include "xconnect.chart" . }}
{{ include "xconnect.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "xconnect.selectorLabels" -}}
app.kubernetes.io/name: {{ include "xconnect.name" . }}
...
*/}}
{{- define "xconnect.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "xconnect.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
